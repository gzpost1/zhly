...
public  class ExternalApiFeignServiceFallback implements FallbackFactory<ExternalApiFeignService> {
    ...
    public ExternalApiFeignService create(Throwable cause) {
        return new ExternalApiFeignService() {
            ...
            @Override
            public IdmResDTO<IPage<VideoPageVo>> queryForPage(VideoPageQuery query) {
            ...
            @Override
            public IdmResDTO<IPage<EntranceGuardRecordVo>> entranceGuardQueryForPage(EntranceGuardRecordReqDTO query) {
