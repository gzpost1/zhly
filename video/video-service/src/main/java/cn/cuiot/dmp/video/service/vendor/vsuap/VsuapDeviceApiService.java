...
public class VsuapDeviceApiService {
     ...
     */
    public VsuapBaseResp<List<VsuapDeviceListResp>> requestDeviceList(VsuapDeviceListReq req) {
     ...
     */
    public VsuapDeviceDetailResp requestDeviceDetail(VsuapDeviceDetailReq req) {
        String gateway = "vsuap-platform-api/v1/device/detail";
        VsuapBaseResp<VsuapDeviceDetailResp> request = vsuapApiService.request(gateway, HttpMethod.POST, req,
     ...
     */
    public VsuapBaseResp<List<VsuapChannelResp>> requestChannel(VsuapChannelReq req) {
     ...
     */
    public VsuapPlayOnResp requestPlayOn(VsuapPlayOnReq req) {
        String gateway = "vsuap-platform-api/v1/device/playOn";
        VsuapBaseResp<VsuapPlayOnResp> request = vsuapApiService.request(gateway, HttpMethod.POST, req,
     ...
     */
    public VsuapBaseResp<List<VsuapRecordListResp>> requestRecordList(VsuapRecordListReq req) {
     ...
     * @return: VsuapBaseResp<List> 录像分页数据
     */
    public VsuapPlayOnFlvHlsResp requestPlayOnFlvHls(VsuapPlayOnReq req) {
        String gateway = "vsuap-platform-api/v1/device/playOnFlvHls";
        VsuapBaseResp<VsuapPlayOnFlvHlsResp> request = vsuapApiService.request(gateway, HttpMethod.POST, req,
