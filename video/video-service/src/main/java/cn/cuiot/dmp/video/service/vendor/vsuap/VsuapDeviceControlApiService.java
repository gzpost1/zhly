...
public class VsuapDeviceControlApiService {
     ...
     * @return: void
     */
    public void requestDeviceControlByIris(VsuapDeviceControlByIrisReq req) {
        String gateway = "vsuap-platform-api/v1/device/deviceControlByIRIS";
        vsuapApiService.request(gateway, HttpMethod.POST, req,
     ...
     * @return: void
     */
    public void requestDeviceControlByFocus(VsuapDeviceControlByFocusReq req) {
     ...
     * @return: void
     */
    public void requestDeviceControlByZoom(VsuapDeviceControlByZoomReq req) {
     ...
     * @return: void
     */
    public void requestDeviceControlByDirection(VsuapDeviceControlByDirectionReq req) {
     ...
     * @return: void
     */
    public void requestPresetConfig(VsuapPresetConfigReq req) {
     ...
     * @return: void
     */
    public void requestPresetDelete(VsuapPresetDeleteReq req) {
     ...
     * @return: void
     */
    public void requestPresetExec(VsuapPresetExecReq req) {
     ...
     * @return: void
     */
    public void requestPresetList(VsuapPresetListReq req) {
     ...
     * @return: void
     */
    public void requestCruiseAddReq(VsuapCruiseAddReq req) {
     ...
     * @return: void
     */
    public void requestCruiseModify(VsuapCruiseModifyReq req) {
     ...
     * @return:
     */
    public void requestCruiseDelete(VsuapCruiseDeleteReq req) {
     ...
     */
    public VsuapBaseResp<List<VsuapCruiseListResp>> requestCruiseList(VsuapCruiseListReq req) {
        String gateway = "vsuap-platform-api/v1/deviceControl/cruiseList";
        return vsuapApiService.request(gateway, HttpMethod.POST, req,
     ...
     */
    public VsuapBaseResp<List<VsuapCruiseConfigListResp>> requestCruiseConfigList(VsuapCruiseConfigListReq req) {
     ...
     */
    public VsuapCruiseConfigAddResp requestCruiseConfigAdd(VsuapCruiseConfigAddReq req) {
        String gateway = "vsuap-platform-api/v1/deviceControl/cruiseConfigAdd";
        VsuapBaseResp<VsuapCruiseConfigAddResp> request = vsuapApiService.request(gateway, HttpMethod.POST, req,
     ...
     * @return: void
     */
    public void requestCruiseConfigModify(VsuapCruiseConfigModifyReq req) {
     ...
     * @return: void
     */
    public void requestCruiseConfigDelete(VsuapCruiseConfigDeleteReq req) {
     ...
     * @return: void
     */
    public void requestStartCruise(VsuapStartCruiseReq req) {
     ...
     * @return: void
     */
    public void requestStopCruise(VsuapStopCruiseReq req) {
