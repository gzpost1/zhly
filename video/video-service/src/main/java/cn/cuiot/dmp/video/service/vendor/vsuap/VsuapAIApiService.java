...
import cn.cuiot.dmp.video.service.vendor.bean.req.vsuap.VsuapAIAlarmListReq;
import cn.cuiot.dmp.video.service.vendor.bean.req.vsuap.VsuapAIMethodListReq;
import cn.cuiot.dmp.video.service.vendor.bean.req.vsuap.VsuapAIStatisticsReq;
...
public class VsuapAIApiService {
     ...
     */
    public VsuapBaseResp<List<VsuapAIMethodListResp>> requestAIMethodList(VsuapAIMethodListReq req) {
     ...
     */
    public VsuapBaseResp<List<VsuapAIAlarmListResp>> requestAIAlarmLis(VsuapAIAlarmListReq req) {
     ...
     */
    public List<VsuapAIStatisticsResp> requestAIStatistics(VsuapAIStatisticsReq req) {
        String gateway = "vsuap-platform-api/v1/ai/queryStatistics";
        VsuapBaseResp<List<VsuapAIStatisticsResp>> request = vsuapApiService.request(gateway, HttpMethod.POST, req,
