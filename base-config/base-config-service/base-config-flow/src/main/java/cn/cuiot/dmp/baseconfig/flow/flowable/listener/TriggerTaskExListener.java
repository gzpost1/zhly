...
import cn.cuiot.dmp.baseconfig.flow.dto.flowjson.HttpInfo;
...
public class TriggerTaskExListener implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) {
        ...
        if("GET".equals(method)){
            ...
            throw new BusinessException(ResultCode.PARAM_CANNOT_NULL,"哪有??");
        }
        if(httpRequest!=null){
            //1.0 对http本身进行个性化设置
            ...
            if(execute.isOk()){
                ...
                throw new BusinessException(ResultCode.PARAM_CANNOT_NULL,"Http Task请求报错!!!!!!!!失败原因是"+body);
            }
