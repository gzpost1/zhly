...
import cn.cuiot.dmp.externalapi.service.vendor.video.config.VideoProperties;
import cn.cuiot.dmp.externalapi.service.vendor.video.enums.VsuapResCode;
import cn.cuiot.dmp.externalapi.service.vendor.video.util.VsuapSignUtil;
...
public class VsuapApiService {
     ...
     */
    public <R, T> VsuapBaseResp<R> request(String gateway, HttpMethod method, T data, VsuapSecretKeyReq secretKeyReq,
                                           TypeReference<VsuapBaseResp<R>> reference) {
        ...
        //AK
        headerMap.put("accessKey", secretKeyReq.getAccessKey());
        ...
        String secretKey = secretKeyReq.getSecretKey();
