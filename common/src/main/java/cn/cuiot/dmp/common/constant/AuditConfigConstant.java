...
public class AuditConfigConstant {
    ...
    public static final List<String> CONTENT_MANAGE_INIT = Lists.newArrayList("新增公告", "编辑公告");
    ...
    public static final List<String> LEASE_CONTRACT_INIT = Lists.newArrayList("合同新建后提交", "合同退租", "合同变更",
            "合同续租", "合同作废");
    public static final List<String> INTENTION_CONTRACT_INIT = Lists.newArrayList("合同新建后提交", "合同退定", "合同作废");
